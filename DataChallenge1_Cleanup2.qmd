...
tmap::tm_shape(zh_stat_zone_sf) +
    ...
    tmap::tm_layout(
      main.title = "Gi*-statistic for light accidents",
      main.title.size = 1.0,
...
tmap::tm_shape(zh_stat_zone_sf) +
    ...
    tmap::tm_layout(
      main.title = "Gi*-statistic for severe accidents",
      main.title.size = 1.0,
      main.title.fontface = "bold",
      main.title.position = c("left", "top"),
      legend.position = c("left", "top"),
...
tmap::tm_shape(zh_stat_zone_sf) +
    ...
    tmap::tm_layout(
      main.title = "Gi*-statistic for fatal accidents",
      main.title.size = 1.0,
      main.title.fontface = "bold",
      main.title.position = c("left", "top"),
      legend.position = c("left", "top"),
...
tmap::tm_shape(zh_stat_zone_sf) +
    ...
    tmap::tm_layout(
      main.title = "Gi*-statistic for accidents with property damage",
      main.title.size = 1.0,
      main.title.fontface = "bold",
      main.title.position = c("left", "top"),
      legend.position = c("left", "top"),
