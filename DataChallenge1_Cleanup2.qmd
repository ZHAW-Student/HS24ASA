...
getisbikedata<-filter(bike_accidents_sf, AccidentYear =="2018"| AccidentYear == "2019")[,c(7,24,38)]
...
getisbikedata$AccidentSeverityCategory <- as.factor(getisbikedata$AccidentSeverityCategory)
...
sads_lG <-
    spdep::localG(x <- as.numeric(as.vector(getisbikedata$AccidentSeverityCategor)), listw = bike_acc_lw)
