...
## Convex Cluster Hulls 2020 data
```{r, echo=FALSE}
hullplot(bike_accidents2020, ops_reach2020, asp = 1)
```

## Convex Cluster Hulls 2021 data
```{r, echo=FALSE}
hullplot(bike_accidents2021, ops_reach2021, asp = 1)
```
:::
...
```
::: {.panel-tabset .nav-pills}
# find best concavity value -> this title does not fit
```{r}
#ggplot() +
  # geom_sf(data = districts, color = "black", fill = NA) +
...
cat("Area of 2018:", sf::st_area(poly2018), "m^2 \n",
    ...
    "Jaccard Index:", sf::st_area(poly_18_19inters)/sf::st_area(poly_18_19union), "m^2 \n")
...
cat("Area of 2018:", sf::st_area(hr18_90sf), "m^2 \n",
    ...
    "Jaccard Index:", sf::st_area(polyhr_18_19inters)/sf::st_area(polyhr_18_19union), "m^2 \n")
```
...
# Plot 
plot(bike_accidents2018_enve1, main = "L-function of 2018 bike acccident points\n with envelope for district 1")
...
zh_stat_zone <- read_csv("Session_5/data/stzh.adm_statzonen_v.csv")
zh_stat_zone_sf <- st_as_sf(zh_stat_zone,wkt = "geometry", crs = 2056)
zh_stat_zone_sf <- zh_stat_zone_sf[, c(1,3,9)]
