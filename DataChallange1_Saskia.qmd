...
First I performed a DBSCAN cluster analysis. But 500 m seem a lot for the distance. Also, the density varies, which is a weakness of DBSCAN. Therefor, I tried using optics.
...
ggplot() +
  ...
  geom_sf(data = cave_acc2018_05, color = "pink", fill = NA) +
  geom_sf(data = cave_acc2018_1, color = "green", fill = NA) +
  geom_sf(data = cave_acc2018_2, color = "blue", fill = NA) + 
...
ggplot() +
  ...
  geom_sf(data = bike_acc2018_c1_con, color = "pink", fill = NA) + 
  geom_sf(data = bike_acc2018_c2, color = "black", size = 0.5) +
  geom_sf(data = bike_acc2018_c2_con, color = "purple", fill = NA) + 
  geom_sf(data = bike_acc2018_c3, color = "black", size = 0.5) +
  geom_sf(data = bike_acc2018_c3_con, color = "green", fill = NA) + 
  geom_sf(data = bike_acc2018_c4, color = "black", size = 0.5) +
  geom_sf(data = bike_acc2018_c4_con, color = "darkgreen", fill = NA) + 
  geom_sf(data = bike_acc2018_c5, color = "black", size = 0.5) +
  geom_sf(data = bike_acc2018_c5_con, color = "blue", fill = NA) + 
  geom_sf(data = bike_acc2018_c6, color = "black", size = 0.5) +
  geom_sf(data = bike_acc2018_c6_con, color = "lightblue", fill = NA) + 
  geom_sf(data = bike_acc2018_c7, color = "black", size = 0.5) +
  geom_sf(data = bike_acc2018_c7_con, color = "orange", fill = NA) + 
  geom_sf(data = bike_acc2018_c8, color = "black", size = 0.5) +
  geom_sf(data = bike_acc2018_c8_con, color = "red", fill = NA) +
  theme_minimal() +
  ggtitle("Clusters of bike accidents 2018")

ggplot() +
  geom_sf(data = bike_acc2019_c1, color = "black", size = 0.5) +
  geom_sf(data = bike_acc2019_c1_con, color = "pink", fill = NA) + 
  geom_sf(data = bike_acc2019_c2, color = "black", size = 0.5) +
  geom_sf(data = bike_acc2019_c2_con, color = "purple", fill = NA) + 
  geom_sf(data = bike_acc2019_c3, color = "black", size = 0.5) +
  geom_sf(data = bike_acc2019_c3_con, color = "green", fill = NA) + 
  geom_sf(data = bike_acc2019_c4, color = "black", size = 0.5) +
  geom_sf(data = bike_acc2019_c4_con, color = "darkgreen", fill = NA) + 
  geom_sf(data = bike_acc2019_c5, color = "black", size = 0.5) +
  geom_sf(data = bike_acc2019_c5_con, color = "blue", fill = NA) + 
  geom_sf(data = bike_acc2019_c6, color = "black", size = 0.5) +
  geom_sf(data = bike_acc2019_c6_con, color = "lightblue", fill = NA) + 
  geom_sf(data = bike_acc2019_c7, color = "black", size = 0.5) +
  geom_sf(data = bike_acc2019_c7_con, color = "orange", fill = NA) + 
  geom_sf(data = bike_acc2019_c8, color = "black", size = 0.5) +
  geom_sf(data = bike_acc2019_c8_con, color = "red", fill = NA) +
  geom_sf(data = bike_acc2019_c9, color = "black", size = 0.5) +
  geom_sf(data = bike_acc2019_c9_con, color = "yellow", fill = NA) + 
  geom_sf(data = bike_acc2019_c10, color = "black", size = 0.5) +
  geom_sf(data = bike_acc2019_c10_con, color = "brown", fill = NA) +
  theme_minimal() +
...
plot(st_coordinates(poly2018), xlab = "Easting [m]", ylab = "Northing [m]", 
     type = "n", asp = 1)
plot(poly2018, border = "darkblue", lwd = 2, add = TRUE)
plot(poly2018_2019_diff, col = "lightblue", border = NA, add = TRUE)
plot(poly2019, col = "pink", border = "purple", add = TRUE)

cat("Area of 2018:", sf::st_area(poly2018), "m^2 \n",
    "Area of 2019: ", sf::st_area(poly2019), "m^2 \n",
    "Difference Area:    ", sf::st_area(poly2018_2019_diff), "m^2 \n")
```
...
bike_acc2018_point <- as(bike_accidents_2018_sf, "Spatial")
bike_acc2019_point <- as(bike_accidents_2019_sf, "Spatial")
...
# Compute UD 2018
ud <- adehabitatHR::kernelUD(bike_acc2018_point, grid = grid_val, extent = ext_val, h = "href")
...
# Compute UD 2019
ud <- adehabitatHR::kernelUD(bike_acc2019_point, grid = grid_val, extent = ext_val, h = "href")
hr95 <- adehabitatHR::getverticeshr(ud, percent = 95)   # retrieve home range (95th volume percentile)
hr50 <- adehabitatHR::getverticeshr(ud, percent = 50)   # retrieve core area (50th volume percentile)
...
# Positioning of legend box is optimized for knitr HTML output
ud <- adehabitatHR::kernelUD(ung_pts_sp, grid = grid_val, extent = ext_val, h = "LSCV")
hr95 <- adehabitatHR::getverticeshr(ud, percent = 95)   # retrieve home range (95th volume percentile)
hr50 <- adehabitatHR::getverticeshr(ud, percent = 50)   # retrieve core area (50th volume percentile)
